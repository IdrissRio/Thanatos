...
/*################################################################
 * This file contains all the needed declarations for functions
 * and matrices used for the implementation of the DES algorithm.
 *
 * encryption or decryption is performed by the 'cipher' method
 * depending on the value passed to the function for the 'mode'
 * parameter ('0' for encryption)
 *
 * Enjoy.
 *
 *###############################################################*/
...
#define FUNCTIONS
#include "mpi.h"   
// defining a new type representing a 'byte' unit
typedef unsigned char byte;
//Definisco un nuovo tipo che mi raccoglie le informazioni relative allo stato del programma.
typedef struct {
    long long possibileChiave;
    long long processID;
    double tempo;
    int tipo;
} infoExec;
...
// defining a small integer representing sizeof(char)
static const byte BYTE = sizeof(char);
...
static const short SHIFTS[] = {
    1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1
};

static const short PC1[] = {
    57, 49, 41, 33, 25, 17,  9,
    1, 58, 50, 42, 34, 26, 18,
    10,  2, 59, 51, 43, 35, 27,
    19, 11,  3, 60, 52, 44, 36,
